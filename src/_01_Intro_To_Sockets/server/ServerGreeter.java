	...
	public void run() {
		...
		while (bool) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Sever waiting for you bro");
				...
				JOptionPane.showMessageDialog(null, "client has connected bro");
				...
				bool = false;
				e.printStackTrace();
				System.out.println("something is messed up bruh");
			}
